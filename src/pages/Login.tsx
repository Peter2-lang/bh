...
export const Login: React.FC = () => {
  ...
  const fill = (em: string, pw: string) => { setEmail(em); setPassword(pw); };
      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 gap-0 bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 md:p-10">
          <div className="md:hidden text-center mb-6">
            <div className="text-2xl font-extrabold text-blue-700">🏠 Madaje's BHMS</div>
          </div>
          ...
          <Card className="mt-6 p-4 bg-slate-50">
            <div className="text-xs font-semibold text-slate-700 mb-2">Demo accounts (click to autofill):</div>
